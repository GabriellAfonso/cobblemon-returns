...
class RankingsViewTest(TestCase):
    ...
    def setUp(self):
        _make_player('uuid-1', 'AshKetchum',  play_time_ticks=72000, pokemons_caught=100,
                     pokedex_registered=50, cobbletcg_cards=20, battles_won=30, cobbledollars=5000)
        _make_player('uuid-2', 'MistyWater',  play_time_ticks=36000, pokemons_caught=80,
                     pokedex_registered=40, cobbletcg_cards=15, battles_won=20, cobbledollars=3000)
        _make_player('uuid-3', 'BrockRock',   play_time_ticks=14400, pokemons_caught=60,
